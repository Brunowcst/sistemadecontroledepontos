...
|               |                                                                |
| ------------- | :------------------------------------------------------------- |
| **Descrição** | O sistema deve manter validar os dados, previamente cadastrados, informados no campo de login. Se autorizado após a validação, deve liberar o usuário para realizar o acesso no sistema. Ele poderá recuperar o acesso na tela de login caso tenha esquecido algum dado. |
